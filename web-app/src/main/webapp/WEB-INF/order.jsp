...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/"><img src="https://iconizer.net/files/Web_Design_Creatives/orig/Cross-lines.png" width="25" height="25"></a></li>
    </ol>
</nav>
...
<%--<div class="card-group">--%>
    ...
    <form action="<%= request.getContextPath() %>" method="post">
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title"><%= model.getProductName() %> </h5>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Price: <%= model.getProductPrice() %> rub.</li>
                    <li class="list-group-item" hidden>
                        <label for="quantity">Quantity: </label>
                        <input type="number" min="0" id="quantity" name="quantity" value="<%= model.getProductQuantity() %>">
                    </li>
                    <li class="list-group-item">Cost: <%= model.getProductPrice() * model.getProductQuantity() %> </li>
