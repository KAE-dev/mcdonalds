...
<%--            <li class="list-group-item">Price: <%= item.getPriceInRub() %></li>--%>
<%--          </ul>--%>
      ...
      <div class="col-3">
        <div class="card mt-3">
          ...
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Price (rub): <%= item.getPriceRub() %></li>
            </ul>
            <% if (item.getCategory().equals(Constants.DRINKS)) { %>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Volume (ml): <%= ((DrinkDto) item).getVolumeMl() %></li>
            </ul>
            <% } %>
            ...
            <form action="<%= request.getContextPath() %>" method="post">
              ...
              <div hidden>
                <li for="quantity"></li>
                <li type="number" min="0" id="quantity" name="quantity" value="1"></li>
              </div>
              <button class="btn btn-primary">Add to card</button>
            </form>
          </div>
